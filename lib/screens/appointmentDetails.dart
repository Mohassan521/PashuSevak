                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16,
                                          color: appointments[index].status == "Open" || appointments[index].status == "Scheduled" ?  Colors.green : Colors.red
                                        ),
                                      ),
                                      Divider(height: 20, thickness: 0.75),
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          //   ),
                                          // ),
                                          appointments[index].status == "Open" || appointments[index].status == "Scheduled"  ? ElevatedButton(
